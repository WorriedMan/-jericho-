...
function taskValid.killPed(task)
	...
	--outputDebugString ( tostring ( isElement(element) and getElementType(element) == "ped" ))
	--outputDebugString ( tostring ( 	tonumber(shootdist) and tonumber(followdist) ))
	--outputDebugString ( tostring ( isElement(element) and getElementType(element) == "ped" and tonumber(shootdist) and tonumber(followdist) and true or false ))
	return
		isElement(element) and getElementType(element) == "player" and
