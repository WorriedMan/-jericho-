...
function addNPCTask(npc,task)
	...
	outputChatBox ("adding "..tostring(task[1]).." "..tostring(task[2]).." "..tostring(task[3]).." "..tostring(task[4]).." ")
	...
	local settask = setElementData(npc,"npc_hlc:task."..lasttask,task)
	-- if getElementData(npc,"npc_hlc:task.4") then
		-- outputChatBox("adding "..tostring(lasttask).." "..tostring(task[1]).." "..tostring(settask).." "..tostring(getElementData(npc,"npc_hlc:task.4")[1]),root,0,200,0)
	-- else
		-- outputChatBox("adding "..tostring(lasttask).." "..tostring(task[1]).." "..tostring(settask).." "..tostring(getElementData(npc,"npc_hlc:task.4")),root,0,200,0)
	-- end
