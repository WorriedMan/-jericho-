things = { -- название вес, цвета, функция, что то, не стак
	...
	{ "Китайский автомат", 7, 255,255,255, "equipFiringWeapon()", false, true }, -- 24
	{ "Патроны 5,56-мм", 0.01, 255,255,255, "equipAmmo()", false, false }, -- 25
	{ "Кий", 2, 0,0,0,"equipMeeleWeapon()", false, true }, -- 26
	{ "Бензопила", 10, 0,0,0,"equipMeeleWeapon()", false, true }, -- 27
	{ "Лопата", 2, 0,0,0,"equipMeeleWeapon()", false, true }, -- 28
	{ "Катана", 1, 0,0,0,"equipMeeleWeapon()", false, true }, -- 29
	{ "Винтовка", 2, 0,0,0,"equipFiringWeapon()", false, true }, -- 30
	{ "Бесшумный", 0.5, 0,0,0,"equipFiringWeapon()", false, true }, -- 31
	{ "Снайперская винтовка", 8, 0,0,0,"equipFiringWeapon()", false, true }, -- 32
	{ "Дробовик", 3, 0,0,0,"equipFiringWeapon()", false, true }, -- 33
	{ "10-мм пистолет", 3, 0,0,0,"equipFiringWeapon()", false, true }, -- 34
	{ "10-мм пистолет-пулемёт", 5, 0,0,0,"equipFiringWeapon()", false, true }, -- 35
	{ "Штурмовая винтовка",7, 0,0,0,"equipFiringWeapon()", false, true }, -- 36
	{ "Дубинка", 2, 0,0,0,"equipMeeleWeapon()", false, true }, -- 37
	{ "Боевой дробовик", 7, 0,0,0,"equipCShot()", false, true }, -- 38
	{ "Горбомет - 1", 10, 0,0,0,"equipFlamethrower()", false, true }, -- 39
	{ "Обрез", 2, 0,0,0,"equipFiringWeapon()", false, true }, -- 40
	{ "Супердубина", 5, 0,0,0,"equipMeeleWeapon()", false, true }, -- 41
	{ ".50 патроны", 0.01, 0,0,0,"equipAmmo()", false, false }, -- 42 
	{ "10мм авто. патроны", 0.05, 0,0,0,"equipAmmo()", false, false }, -- 43
	{ ".32 патроны", 0.01, 0,0,0,"equipAmmo()", false, false }, -- 44
	{ "10-мм патроны", 0.05, 0,0,0,"equipAmmo()", false, false }, -- 45
	{ "Дробь", 0.05, 0,0,0,"equipAmmo()", false, false }, -- 46
	{ ".308 патроны", 0.01, 0,0,0,"equipAmmo()", false, false }, -- 47
	{ "12.7 патроны", 0.02, 0,0,0,"equipAmmo()", false, false }, -- 48
	{ "Гриб", 0.5, 0,0,0,"eatFungus()", false, false }, -- 49
	{ "Сансет саспарилла", 1, 0,0,0, "drinkSunset()", false, false }, -- 50
	{ "Крышки", 0.001, 0,0,0, "useCap()", false, false }, -- 51
	...
	{ 'Ствол (дробовик)', 0.5, 0, 0, 0, "useWeaponPart()", false, true }, -- 79
	...
	{ 'Миниган', 10, 0, 0, 0, "equipFiringWeapon()", false, true }, -- 94
	...
	{ 'Рейнджер', 10, 0, 0, 0, "wearRangerArmor()", false, true }, -- 98
	...
	{ 'Пустая батарея', 0.1, 0, 0, 0, "useWeaponPart()", false, false }, -- 119
	...
	{ "9-мм пистолет", 1.5, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 129
	{ "9-мм патроны", 0.01, 255, 255, 255, "equipAmmo()", false, false }, -- 130
	{ "Гильзы 9-мм", 0.001, 0, 0, 0, "useShell()", false, false }, -- 131
	{ "9-мм пистолет+", 1.5, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 132
	{ "Мария", 1, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 133
	{ "9-мм пистолет-пулемёт", 4, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 134
	{ "12,7-мм пистолет-пулемёт", 5, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 135
	{ "Винтовка Гаусса", 7, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 136
	{ "Микроядерная батарея", 0.1, 255, 255, 255, "equipAmmo()", false, false }, -- 137
	{ "12,7-мм пистолет", 3.5, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 138
	{ "12,7-мм пистолет+", 3.5, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 139
	{ "Револьвер Магнум кал. 357", 2, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 140
	{ "Патрон кал. 357 'Магнум'", 0.035, 255, 255, 255, "equipAmmo()", false, false }, -- 141
	{ "Гильза .357 'Магнум'", 0.03, 0, 0, 0, "useShell()", false, false }, -- 142
	{ "Бластер Чужих", 2, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 143
	{ "Охотничий револьвер", 4, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 144
	{ "Секвойя рейнджера", 4, 255, 255, 255, "equipFiringWeapon()", false, true }, -- 145
	{ "Патрон кал. 45-70", 0.065, 255, 255, 255, "equipAmmo()", false, false }, -- 146
	{ "Гильза кал. 45-70", 0.06, 0, 0, 0, "useShell()", false, false }, -- 147
	{ "10-мм пистолет+", 3, 0,0,0,"equipFiringWeapon()", false, true }, -- 148
	{ "Китайский автомат+", 7, 255,255,255, "equipFiringWeapon()", false, true }, -- 149
	{ "Китайский автомат Джерико", 7, 255,255,255, "equipFiringWeapon()", false, true }, -- 150
	{ "Ланчбокс Волт-Тек №1", 0, 255,255,255, "openVaultTecCase(1)", false, false }, -- 151
	{ "Штурмовая винтовка+",7, 0,0,0,"equipFiringWeapon()", false, true }, -- 152
	{ "Гильзы 5,56-мм", 0.001, 0,0,0, "useShell()", false, false }, -- 153
	{ "Патрон кал. 308", 0.055, 255, 255, 255, "equipAmmo()", false, false }, -- 154
	{ "Гильза кал. 308", 0.05, 0, 0, 0, "useShell()", false, false }, -- 155
	{ "Винтовка резервиста",10, 0,0,0,"equipFiringWeapon()", false, true }, -- 156
	{ "Винтовка «Виктория»",8, 0,0,0,"equipFiringWeapon()", false, true }, -- 157
	{ "Ланчбокс Волт-Тек №2", 0, 255,255,255, "openVaultTecCase(2)", false, false }, -- 158
	{ "Инфильтратор", 7, 255,255,255, "equipFiringWeapon()", false, true }, -- 159
	{ "Дырокол", 7, 255,255,255, "equipFiringWeapon()", false, true }, -- 160
	{ "Сырая рука гуля", 3, 255, 255, 255, "checkZombHand()", false, false }, -- 161
}
...
function getPlayerCaps()
	return getItemAmount(51)
end

function checkZombHand()
...
function useRepairKit ()
	if getElementData ( localPlayer, "repair_ready" ) then
		...
		exports.pipboy:addInfoBox("Выберите предмет для починки и нажмите на него",2)
		...
		if getElementData ( localPlayer, "invWeight" )+things[id][2] <= getElementData ( localPlayer, "maxWeight" ) or effects then
			...
			if not things[id][8] then
				...
				if present then
					...
					local weapon = getPlayerCurrentWeapon()
					if weapon and weaponToAmmo[weapon] == id then
						setElementData ( localPlayer, "currAmmoAmount", alreadyQuant+quant )
					--	triggerServerEvent ( "givePlayerCustomAmmoC", localPlayer, currAmmo, currAmmoAmount, false )
					end
					inventory[present][2] = alreadyQuant + quant
					slot = present
					triggerEvent ( "playerGetItem", localPlayer, {id = id, quant = quant, newamount = alreadyQuant + quant} )
				else
					table.insert ( inventory, { id, quant} )
					slot = #inventory
					triggerEvent ( "playerGetItem", localPlayer, {id = id, quant = quant, newamount = quant} )
				end
			else
				for i = 1, quant do
					table.insert ( inventory, { id, 1, qty or math.random(0,100)} )
					slot = #inventory
					triggerEvent ( "playerGetItem", localPlayer, {id = id, quant = 1, qty = qty} )
				end
			end
			triggerServerEvent ( "updatePlayerInventory", localPlayer, inventory )
			if not effects then
...
function getItemAmountByID ( id )
	--outputDebugString("inventory[id]  "..tostring(inventory[id][2]).." "..tostring(inventory[id][1]) .. " "..tostring(id))
	...
	if id and quant then
		if not things[id][8] then
			...
			if present then
				local alreadyQuant = inventory[present][2]
				local weapon = getPlayerCurrentWeapon()
				if weaponToAmmo[weapon] == id then
					setElementData ( localPlayer, "currAmmoAmount", alreadyQuant+quant )
				end
				inventory[present][2] = alreadyQuant + quant
				triggerEvent ( "playerGetItem", localPlayer, {id = id, quant = quant, newamount = alreadyQuant + quant} )
...
function removePlayerItem ( id, quant )
	if things[id][8] and quant > 1 then
		...
		if slotID then
			...
			--outputChatBox("wasQuant "..wasQuant.." "..tostring(inventory[slotID][1]))
			if wasQuant > 0 then
				local ammo = false
				local weapon = false
				local wname = getPlayerCurrentWeapon()
				if wname then
					if weaponToAmmo[wname] == id then
						ammo = true
					elseif currWeaponInventoryID == slotID then
						weapon = true
					end
				end
				
				--outputChatBox("wasQuant > quant "..wasQuant.." "..quant)
...
function getItemOffsetLargeNull(slot)
	local offset = 0
	for i = 1, slot-1 do
		if not inventory[i] or inventory[i][2] < 1 then
			offset = offset+1
		end
	end
	return offset
...
function removePlayerItemByPos ( pos, quant )
	if inventory[pos] then
		...
		if wasQuant > 0 then
			...
			local weapon = false
			local wname = getPlayerCurrentWeapon()
			--local offset = getItemOffsetLargeNull(pos)
			if wname and weaponToAmmo[wname] == id then
				ammo = true
			elseif pos == currArmorInvPos then
				armor = true
			elseif pos == currWeaponInventoryID then
				weapon = true
			end
			if wasQuant > quant then						
				inventory[pos][2] = wasQuant - quant
				if ammo then
					currAmmoAmount = getElementData (localPlayer,"currAmmoAmount")-quant
					setElementData ( localPlayer, "currAmmoAmount", currAmmoAmount )
				end
			else
				inventory[pos][2] = 0
...
function eatSmallRat ()
	if checkNotInArmor () then
		...
		exports.pipboy:addInfoBox("Вы получили 5 пунктов радиации",3)
...
function useAntiRad ()
	...
	if getElementData ( localPlayer, "perk11" ) then
		...
		local half = math.floor ( health*0.3 )
...
function eatNuts()
	if checkNotInArmor () then
		exports.players:takePlayerEatClient ( 3 )
...
function useMadreCoins ()
	if getElementData ( localPlayer, "quest_coins" ) == 0 then
		...
		exports.pipboy:addInfoBox ("Морган Фриман заплатит по 20 крышек за каждую такую монету.", 3 )
	end
...
function drinkSunset()
	if checkNotInArmor () then
		...
		triggerServerEvent ( "sendActionMessageTextC", getLocalPlayer(), 'выпивает бутылку Сансет Саспариллы' )
		playEatAnimation ( 2 )
	end
end
...
function drinkCola ()
	if checkNotInArmor () then
		...
		exports.players:takePlayerEatClient ( 2 )
		givePlayerItem ( 51, 1 )
		triggerServerEvent ( "sendActionMessageTextC", getLocalPlayer(), 'выпивает бутылку Ядер-Колы' )
		if getElementData ( localPlayer, "perk1" ) then
			exports.pipboy:addInfoBox("Хорошо, что у вас свинцовое брюхо!", 2 )
		else
...
function eatApple ()
	if checkNotInArmor () then
		exports.players:takePlayerEatClient ( 7 )
		exports.players:givePlayerNewHealth ( 5 )
		triggerServerEvent ( "sendActionMessageTextC", getLocalPlayer(), 'ест свежее яблоко' )
		playEatAnimation ( 1 )
	end
end
...
function openVaultTecCase(case)
	if not exports.case:isOpeningGoing() then
		exports.pipboy:closePipBoy ()
		exports.case:showCaseOpening(case)
	end
end