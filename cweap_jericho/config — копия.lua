...
weaponStats = {-- x вперед y вбок z вверх
	...
	["Мария"] = { kind = "colt 45", id = 22, damage = 20, noise = 1, fire_rate = 263, crit_chance = 2, object_offset = {x = 0, y = 0, z = 0, rx = 0, ry = 270, rz = 0}, offset = {x = 0.25, y = 0.03, z = 0.125}, object = 1669, camshake = 0.1, sound_folder = "colt45", clip = 13, props = { ["accuracy"] = { 0.8, 0.8, 0.8 } },mod_name="maria", reload_anim = {{"COLT45","colt45_reload"},{"COLT45","colt45_crouchreload"}},},
	...
	["12,7-мм пистолет"] = { kind = "colt 45", id = 22, damage = 40, noise = 1, crit_chance = 1, fire_rate = 366, object_offset = {x = 0, y = 0, z = 0, rx = 0, ry = 270, rz = 0}, offset = {x = 0.25, y = 0.03, z = 0.125}, object = 1862, camshake = 0.2, sound_folder = "127mm", clip = 7, props = { ["accuracy"] = { 0.6, 0.6, 0.6 } },mod_name="127pistol", reload_anim = {{"COLT45","colt45_reload"},{"COLT45","colt45_crouchreload"}},},
	["12,7-мм пистолет+"] = { kind = "colt 45", id = 22, damage = 40, noise = 1, crit_chance = 1, fire_rate = 366, object_offset = {x = 0, y = 0, z = 0, rx = 0, ry = 270, rz = 0}, offset = {x = 0.25, y = 0.03, z = 0.125}, object = 1862, camshake = 0.2, sound_folder = "127mm", clip = 14, props = { ["accuracy"] = { 0.6, 0.6, 0.6 } }, reload_anim = {{"COLT45","colt45_reload"},{"COLT45","colt45_crouchreload"}},},
	...
	["Кий"] = { damage = 30, id = 0, onehand = true },
	["Лопата"] = { damage = 20, id = 0, onehand = true },
	["Дубинка"] = { damage = 28, id = 0, onehand = true },
	["Бензопила"] = { damage = 35, id = 0, onehand = true },
	["Катана"] = { damage = 50, id = 0, onehand = true },
	["Супердубина"] = { damage = 100, id = 0, onehand = true },
...
weaponModels = {
	...
	["Штурмовая винтовка+"] = { coords = {3,0.19,-0.15,-0.1,0,270,0}, id = 30, model = 1869},
	["9-мм пистолет"] = { coords = {14,0.11,0,0,180,90,270}, id = 22, model = 1858},
	["9-мм пистолет+"] = { coords = {14,0.11,0,0,180,90,270}, id = 22, model = 1859},
	["Мария"] = { coords = {14,0.11,0,0,180,90,270}, id = 22, model = 1669},
	...
	["12,7-мм пистолет"] = { coords = {14,0.11,0,0,180,90,270}, id = 22, model = 1862},
	["12,7-мм пистолет+"] = { coords = {14,0.11,0,0,180,90,270}, id = 22, model = 1862},
...
weapons_toremove = { -- Если ставишь на какую то из стандартных пушек несколько моделей, то удали -- перед нужной строкой. Сейчас -- нету перед M4
	346, -- Pistol
	347, -- Silenced Pistol
	--348, -- Desert Eagle
	--349, -- Shotgun
