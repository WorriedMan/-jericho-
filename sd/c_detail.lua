...
function enableDetail()
	...
	grass = dxCreateTexture('images/1.png', "argb")
--	grassstone = dxCreateTexture('images/16.png', "argb")
	...
	if brickWallShader then
		...
		grassStones = getGrassStoneShader()
	...
	effectParts = {
						...
						concreteShader, sandShader, grassStones
					}
	...
	if not bAllValid then
		...
		-- engineApplyShaderToWorldTexture ( mudShader, "*road*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*tar*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*asphalt*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*freeway*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*wall*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*floor*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*sav*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*san*" )
		-- engineApplyShaderToWorldTexture ( mudShader, "*block*" )
		...
		-- engineApplyShaderToWorldTexture ( grassShader, "sv_sand" )
		...
		engineApplyShaderToWorldTexture ( grassShader, "desgrassbrn" )	-- grass
	--	engineApplyShaderToWorldTexture ( grassStones, "brngrss2stones" )	-- grass
...
function getGrassStoneShader()
	return getMakeShader( getGrassStonesSettings () )
end
...
function getGrassStonesSettings ()
	local v = {}
	v.texture=grassstone
	v.detailScale=2
	v.sFadeStart=60
	v.sFadeEnd=100
	v.sStrength=0.6
